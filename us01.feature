Feature: US01: Crear Usuario - Pacientes
    Como psicólogo necesito ingresar a nuevos pacientes para mantener su información actualizada
    ...
    When  el psicólogo quiera ingresar un nuevo perfil podrá visualizar una opción de registrar nuevo paciente.
    ...
    Given  la información del usuario puede cambiar a lo largo del tiempo, es necesario mantenerlo actualizado para no perder
    datos.
