Feature: US010: Visualizar botón Descargar.
    Como usuario, me parece útil que exista un botón que lleve a la página de la aplicación en las tiendas de 
    Android/iOS, de esa forma se puede descargar fácilmente.
    ...
    Given Se haga click en el botón “Descárguelo ahora en iOS/Android”.
		When Al usuario se le redirigirá a la Play Store o a la App Store dependiendo del sistema 
    ...
    Examples:
        ...
        | Redirección a App Store/Play Store | 
